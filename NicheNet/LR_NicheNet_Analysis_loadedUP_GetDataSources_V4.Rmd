...
write.table(
  intercell_refs,
  file = paste0(proj_long, "/sankey_inferredLT/Up_in_Stretched_Top1to10-ligands-byLog2FC_all-LRlinks_all-LTlinks_Table_InferredLTPaths_LR-DataSources_OmniPath_V4.csv"),
...
write.table(
  ...
  file = paste0(proj_long, "/sankey_inferredLT/Up_in_Stretched_Top1to10-ligands-byLog2FC_all-LRlinks_all-LTlinks_Table_InferredLTPaths_LT-DataSources_V4.csv"),
  row.names = FALSE, quote = FALSE, sep = ",")
